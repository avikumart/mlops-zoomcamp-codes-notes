...
@flow
def main_flow(train_path: str = 'F:\mlops-zoomcamp-codes-notes\yellow_tripdata_2022-01.parquet', 
                val_path: str = 'F:\mlops-zoomcamp-codes-notes\yellow_tripdata_2022-02.parquet'):
